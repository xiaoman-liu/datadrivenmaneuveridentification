...
scenarios_data = deque()
sample_num = 0
top_k_scenario = 180 # total scenarios = 244
# keys = None
scenario_num = 0
scenario_list = [201,202,203,205,206,207,208,209,210,211,212,213,214,215,216,218,221,
                 222,223,224,225,226,228,229,230,231,232,233,234,235,236,237,238,239,
                 240,242,243,244,246,247,248,249,250,251,252,255,256,257,258,259,260,
                 261,262,263,264,265,266,267]
# scenario_keys = "%s"%scenario_list
scenario_keys = "%s"%"last_58_scenarios"
scenarios_name = []
