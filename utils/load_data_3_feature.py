...
def load_scenario_data():
    ...
    features = np.zeros((sample_number, max_timestep, 2+16), dtype=np.float32)
    ...
    for i, scenario_data in enumerate(scenarios_data):
        ...
        for key in scenario_data:
            ...
            features[index, :signal_value.shape[0], signal_value.shape[1]:signal_value.shape[1] + 16] = onehot_laneid
