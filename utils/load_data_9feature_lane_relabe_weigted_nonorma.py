...
def load_scenario_data():
    ...
    features    = np.zeros((sample_number, max_timestep, 5 + 1 + 28 + 2 +2 + 5), dtype=np.float32)
    ...
    for i, scenario_data in enumerate(scenarios_data):
        ...
        for key in scenario_data:
            ...
            features[index, :signal_value.shape[0], total_signal_shape + 31:total_signal_shape + 33] = if_changelane
            features[index, :signal_value.shape[0], total_signal_shape + 33:total_signal_shape + 38] = onehot_type
