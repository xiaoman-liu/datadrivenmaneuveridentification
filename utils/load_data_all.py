...
def load_scenario_data():
    ...
    features    = np.zeros((sample_number, max_timestep, 10 + 1 + 28 + 16 + 5), dtype=np.float32)
    ...
    for i, scenario_data in enumerate(scenarios_data):
        ...
        for key in scenario_data:
            ...
            # numerical feature
            signal_value       = scenario_data[key]['signals'].values[:, [0,1,2,3,5,6,11]] # time , scoordinate, roadyaw,shape = ()
