...
def load_scenario_data():
    ...
    features    = np.zeros((sample_number, max_timestep, 16), dtype=np.float32)
    ...
    for i, scenario_data in enumerate(scenarios_data):
        ...
        for key in scenario_data:
            #
            # # numerical feature
            signal_value       = scenario_data[key]['signals'].values[:, [8]] # time , scoordinate, roadyaw,shape = ()
            ...
            features[index, :signal_value.shape[0], :16] = onehot_laneid
